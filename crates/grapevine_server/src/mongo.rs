...
// doc! {
//     "$match": {
//         "relation": Bson::ObjectId("66abf95c0fe99aec6a7b3ef4".parse()?),
//         "scope": Bson::ObjectId("66abf9540fe99aec6a7b3eec".parse()?),
//         "inactive": false
//     }
// },
// doc! {
//     "$project": { "proof": 0, "nullifiers": 0 }
// },
...
//                         "$and": [
//                             { "$eq": ["$_id", "$$ROOT._id"] },
//                             { "$eq": ["$relation", Bson::ObjectId("66abf95c0fe99aec6a7b3ef4".parse()?)] },
//                             { "$eq": ["$scope", Bson::ObjectId("66abf9540fe99aec6a7b3eec".parse()?)] }
//                         ]
//                     }
//                 ]
//             }
...
//                             ]
//                         },
//                         { "$eq": ["$downstream", Bson::Null] },
//                         { "$eq": ["$downstream", Bson::Array(vec![Bson::Null])] }
//                     ]
//                 },
//                 "then": true,
//                 "else": false
